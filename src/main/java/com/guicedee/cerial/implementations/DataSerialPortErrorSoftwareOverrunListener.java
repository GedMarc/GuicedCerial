...
@Setter
@Log
public class DataSerialPortErrorSoftwareOverrunListener implements SerialPortDataListener {

    private SerialPort comPort;
    private CerialPortConnection<?> connection;

    public DataSerialPortErrorSoftwareOverrunListener(SerialPort comPort, CerialPortConnection<?> connection) {
